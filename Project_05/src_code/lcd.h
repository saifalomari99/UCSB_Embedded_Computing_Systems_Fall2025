...
#include "lab2a.h"   /* for Lab2A and wave_type_t */
...
// Dominic functions ------------------------------
void trianglePrint(int x1, int y1, int x2, int y2);
void setBackground();

void initVolumeTable(void);
void drawVolumeBar(int vol);
void updateVolumeBar(int vol);
void clearVolumeBar(void);

void messageBoxInit(void);
void printButtonMessage(int btn);
void clearButtonMessage(void);
void startScreen(void);
void drawWelcomeScreen(void);
const char *waveTypeToString(wave_type_t w);
