...
void sevenseg_draw_digit (int position, int value)
{
	...
	digit_mask = 255 ^ (1<<position);
   	...
   	Xil_Out32(XPAR_SEVENSEG_V1_0_0_BASEADDR, combined_mask | 127);  // Move anode, turn off display
   	Xil_Out32(XPAR_SEVENSEG_V1_0_0_BASEADDR, combined_mask); 		// Enable display
}
